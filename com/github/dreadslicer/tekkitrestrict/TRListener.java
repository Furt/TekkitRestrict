...
public class TRListener implements Listener {
	...
	public void onPlayerQuit(org.bukkit.event.player.PlayerQuitEvent e) {
		if (tekkitrestrict.config.getBoolean("UseItemLimiter")) {
			TRLimitBlock.setExpire(e.getPlayer().getName());
			TRNoHack.playerLogout(e.getPlayer());
		}
	}
	...
	public void onPlayerLogin(org.bukkit.event.player.PlayerJoinEvent e) {
		...
		TRPermHandler.testPerms(e.getPlayer());
		TRNoDupe_BagCache.setCheck(e.getPlayer());
	}
	...
	public void onPlayerMoveEvent(org.bukkit.event.player.PlayerMoveEvent e) {
		...
		if (AntiFly) {
			TRHandleFly.handleFly(e);
			TRNoHackSpeed.handleMove(e);
		}
	}
